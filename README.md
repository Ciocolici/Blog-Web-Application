...
*To see the page you can access this [link](https://blog-web-application-1kcr.onrender.com/). !!! I do not take any responsability for the Posts on the page, because anyone can visit the site, create new posts, edit older ones and add new ones. Authorisation and fixes are in plan for the project! !!!*
